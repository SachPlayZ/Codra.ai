import DualCodeWindows from "./DualCodeWindows";
              ...
              <BlurFade delay={0.25 * 4} inView>
                <div className="flex justify-start space-x-4">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-white/60 dark:bg-gray-900/30 backdrop-blur-sm rounded-xl border border-gray-300 dark:border-gray-800 hover:border-gray-400 dark:hover:border-gray-700 transition-all duration-300 hover:scale-105 font-semibold"
                  >
                    Learn More
                  </button>
                </div>
